        ...
        <section className={styles.create_page}>
            ...
            <div className={styles.detail_section}>
                ...
                <div className={styles.discription}>
                    ...
                    <p>Pick from 20,000+ premium, royalty free images you can use anywhere without attributing them.</p>
                    <br />
            ...
            <div className={styles.about_section}>
                <h1>Bring your images to life with custom <br /> image generation models.<span>Contact Us Below</span></h1>
                <Link to='/editing'>Contact Us</Link>
            </div>
        </section>
    )
}
