...
const Signup = () => {
    ...
    const fetchData = async (whichForm, enteredEmail, enteredPassword) => {
        ...
        const url = whichForm === 'signup'
            ? 'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyC7m3nD16TbpBofpeGngyK7iK4vo_n-8Uk'
            : 'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyC7m3nD16TbpBofpeGngyK7iK4vo_n-8Uk';
    ...
    const sendEmailVerification = async (token) => {
        const response = await fetch('https://identitytoolkit.googleapis.com/v1/accounts:sendOobCode?key=AIzaSyC7m3nD16TbpBofpeGngyK7iK4vo_n-8Uk',
            {
                method: 'POST',
