    ...
    return (
        <section className={styles.explore_page}>
            ...
            <div className={styles.explore_imgs}>
                ...
                <Link to={'/category/Mecha'} className={styles.img_section}>
                    <img src={require("../../assets/Mecha_Cover.png")} alt='img' />
                    <div className={styles.text_on_img}>
                        <h2>Mecha</h2>
                    </div>
                </Link>
                ...
                <Link to={'/category/Portrait'} className={styles.img_section}>
                ...
                <Link to={'/category/Space'} className={styles.img_section}>
                    <img src={require("../../assets/Space_Cover.png")} alt='img' />
                    <div className={styles.text_on_img}>
                        <h2>Space</h2>
                    </div>
                </Link>
                <Link to={'/category/Sports'} className={styles.img_section}>
                    <img src={require("../../assets/Sports_Cover.png")} alt='img' />
                    <div className={styles.text_on_img}>
                        <h2>Sports</h2>
                    </div>
                </Link>
                <Link to={'/category/Storybook Realism'} className={styles.img_section}>
                    <img src={require("../../assets/Storybook Realism_Cover.png")} alt='img' />
                    <div className={styles.text_on_img}>
                        <h2>Storybook Realism</h2>
                    </div>
                </Link>
            </div>
        </section>
