            ...
            <div className={styles.subscription_plans}>
                ...
                <div className={styles.plan}>
                    ...
                    <ul>
                        ...
                        <li>Unlimited photo and visual generations</li>
                        <li>Remove watermarks, unlimted storage, and more.</li>
                    </ul>
            ...
            <div className={styles.ques_ans_section}>
                ...
                <div className={styles.column}>
                    ...
                    <div>
                        ...
                        <p>We use Stripe for payment and do not store any of your credit card information.</p>
                    </div>
                    <div>
                        <h2>Can I use photos for commercial projects?</h2>
                        <p>Yes, you can use the content for commercial projects. We do not charge any fees for
